      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-primary-foreground/80 mb-2">Get in touch via email</p>
            <a
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-primary-foreground/80 mb-2">Speak with our team</p>
            <a
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-primary-foreground/80 mb-4">Follow us on social media</p>
      ...
      <div className="border-t border-primary-foreground/20">
        <div className="container mx-auto px-4 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/70">
            <p>© 2024 Aaraam Properties. All rights reserved.</p>
