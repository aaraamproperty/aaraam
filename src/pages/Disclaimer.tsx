          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 border-2 border-[#004861]/10 shadow-lg space-y-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                without notice. While we strive to keep information accurate and
                up-to-date, Aaraam Properties does not guarantee that all
                listings are current or available. We recommend contacting us
                directly to verify property details before making any decisions.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                provided or maintained by Aaraam Properties. We do not guarantee
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                The information on this website is not intended to be a
                substitute for professional real estate, legal, or financial
                advice. Always seek the advice of qualified professionals
                regarding your specific real estate needs and circumstances.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Under no circumstance shall Aaraam Properties have any liability
                ...
                on the site. Your use of the site and your reliance on any
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                without notice. Please review this page periodically for
                changes.
              </p>
            </div>
