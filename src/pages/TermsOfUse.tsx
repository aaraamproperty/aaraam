          ...
          <div className="bg-card rounded-3xl p-8 lg:p-12 border border-border space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Terms of Use and our Privacy Policy. If you do not agree with these terms, 
            ...
            <div>
              <h2 className="text-2xl font-bold text-primary mb-4">Property Information</h2>
              <p className="text-muted-foreground leading-relaxed">
                All property listings, prices, and details are provided for informational purposes 
                and are subject to change without notice. Aaraam Properties makes no guarantees 
                about the availability or accuracy of listed properties. Any agreement to lease or 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                is the property of Aaraam Properties and protected by copyright and trademark laws. 
            ...
            <div>
              <h2 className="text-2xl font-bold text-primary mb-4">User Submissions</h2>
              <p className="text-muted-foreground leading-relaxed">
                By submitting inquiries, reviews, or other content to our website, you grant 
                Aaraam Properties a non-exclusive, royalty-free license to use, modify, and 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                for the content or practices of these external sites. Accessing third-party 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Aaraam Properties shall not be liable for any indirect, incidental, special, 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree to indemnify and hold harmless Aaraam Properties from any claims, 
                damages, or expenses arising from your use of the website or violation of 
                these terms.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                For questions about these Terms of Use, please contact us at legal@aaramproperties.com
              </p>
            </div>
